...
// makeA_partial_cpp
List makeA_partial_cpp(arma::mat Pedigree, std::vector<std::string> IND_name, IntegerVector record_pos);
RcppExport SEXP _cBar2_makeA_partial_cpp(SEXP PedigreeSEXP, SEXP IND_nameSEXP, SEXP record_posSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(makeA_partial_cpp(Pedigree, IND_name, record_pos));
    return rcpp_result_gen;
END_RCPP
}
// makeAinv_partial_cpp
List makeAinv_partial_cpp(arma::mat Pedigree, std::vector<std::string> IND_name, IntegerVector record_pos);
RcppExport SEXP _cBar2_makeAinv_partial_cpp(SEXP PedigreeSEXP, SEXP IND_nameSEXP, SEXP record_posSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type Pedigree(PedigreeSEXP);
    Rcpp::traits::input_parameter< std::vector<std::string> >::type IND_name(IND_nameSEXP);
    Rcpp::traits::input_parameter< IntegerVector >::type record_pos(record_posSEXP);
    rcpp_result_gen = Rcpp::wrap(makeAinv_partial_cpp(Pedigree, IND_name, record_pos));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_cBar2_makeA_partial_cpp", (DL_FUNC) &_cBar2_makeA_partial_cpp, 3},
    {"_cBar2_makeAinv_partial_cpp", (DL_FUNC) &_cBar2_makeAinv_partial_cpp, 3},
